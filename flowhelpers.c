 ...
 * @av: pointer to array of user of string
 * @PATH: pointer to PATH string
 * @copy: pointer to copy of PATH string
 *
 * Return: a pointer to copy string to call execve on
 */
...
/**
 * checkbuiltins - checks if first user string is a buit in
 ...
 * @av: pointer to array of user of srings
 * @buffer: ointer to user string
